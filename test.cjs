/**
 * Test script for @chnak/speak (CJS)
 * Run: npm test
 */

const { Speaker } = require('./dist/index.cjs');
...
function createToneBuffer(frequency, durationMs, sampleRate, channels) {
...
async function test() {
  console.log('Testing Speaker (CJS)...\n');
